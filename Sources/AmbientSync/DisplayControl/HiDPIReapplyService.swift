...
public final class HiDPIReapplyService {
    ...
    public func startService() {
        ...
        // Uyku/uyanma bildirimlerini dinle
        ...
        // Ekran parametre değişimlerini dinle
        ...
        // CGDisplayReconfigurationCallback kaydı
    ...
    @objc private func handleWakeNotification() {
        print("[HiDPIReapplyService] Sistem uykudan uyandı, reapply tetikleniyor.")
        triggerReapplyDebounced()
    }
    
    @objc private func handleDisplayChangeNotification() {
        print("[HiDPIReapplyService] Ekran parametreleri değişti, reapply tetikleniyor.")
        triggerReapplyDebounced()
    }
